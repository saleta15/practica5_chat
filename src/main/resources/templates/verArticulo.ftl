                    ...
                    <div class="row">
                        ...
                        <#if articulo.valoracion gte 0 >
                            <button class="btn btn-success"
                                    style="font-size: 20px; border-radius: 100%">${articulo.valoracion}</button>
                        <#else>
                    ...
                    <#if !articulo.estaValorado>
                        <div class="col-lg-2" style="margin-top: 16px">
                            <form method="post" action="/megustaArticulo/">
                                ...
                                <button type="submit" name="action" value="like" class="btn btn-success"><span
                                        class="glyphicon glyphicon-thumbs-up"></span></button>
                                <button type="submit" name="action" value="dislike" class="btn btn-danger"><span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <#if comentario.valoracion gte 0 >
                                <button class="btn btn-success"
                                        style="font-size: 20px; border-radius: 100%">${comentario.valoracion}</button>
                            <#else>
                                <button class="btn btn-danger"
                                        style="font-size: 20px; border-radius: 100%">${comentario.valoracion}</button>
                            </#if>
        ...
        <#if autorOn>
            <div class="col-lg-3">
                ...
                <div class="panel panel-default" >
                    ...
                    <div class="panel-body" >
                        <h5>Chatea con el autor</h5>
                        <hr>
                        <form action="/chatRoom/autor" role="form">
                            <div class="form-group">
                                <label for="nombre">Digita tu nombre:</label>
                                <input type="text" class="form-control" name="nombre">
                                <input type="hidden" value="${articulo.autor.username}" name="autor">
                            </div>
                            <button type="submit" class="btn btn-info" >Chatear</button>
                        </form>
